            ...
            <footer className="mx-auto  flex flex-row p-2 text-center items-center footer bg-neutral text-neutral-content flex justify-between px-4">
                ...
                <div className="grid-flow-col gap-4 text-center pr-2">
                    <div>
                        ...
                        <a
                            rel="noreferrer"
                            href="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=EfeUHoUp3rioczrok8RYIkXwB-uY4usT&authKey=RdqYrMgZ09qv7sFjHJNRKunfZJek8KcfnWo0Y4qwctwaD1VO1hs8%2BDX5KQ6hmqx4&noverify=0&group_code=863584068"
                            target="_blank"
